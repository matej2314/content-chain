...
Zachowaj to, czego verifier nie zakwestionował: liczba sekcji, narracja pod `contentKind`, `id` szkicu i sekcji jeśli były. Każda sekcja nadal: `heading` + `summary` 1–2 zdania. Nie pisz pełnego body.
...
To jest poprawiona wersja tego samego szkicu (jeden obiekt, nie tablica wariantów).
